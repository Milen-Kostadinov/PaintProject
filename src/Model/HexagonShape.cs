    ...
    internal class HexagonShape : Shape
    {
        ...
        private void CalcPoints()
        {
            PointF[] points1 = { new PointF(StartPoint.X + Width * 0.5f, StartPoint.Y),
                new PointF(StartPoint.X, StartPoint.Y + Height * 0.2f),
                new PointF(StartPoint.X, StartPoint.Y + Height * 0.8f),
                new PointF(StartPoint.X + Width * 0.5f, StartPoint.Y + Height),
                new PointF(StartPoint.X + Width, StartPoint.Y + Height * 0.8f),
                new PointF(StartPoint.X + Width, StartPoint.Y + Height * 0.2f),
            };
            points = points1;
        }
